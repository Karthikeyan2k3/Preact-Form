...
function SignalsForm(){
    ...
    return(
        <form onSubmit={displayName}>
            ...
            <label />Allow Contact : <input type="checkbox" onClick={toggleContact}/><br/>
            <label />Phone <input type="radio" value={"Phone"} name={"contact"} onClick={e=>contactMethod.value = e.currentTarget.value } disabled={!allowContact.value}/>
            <label />E-Mail <input type="radio" value={"Mail"} name={"contact"} onClick={e=>contactMethod.value = e.currentTarget.value } disabled={!allowContact.value}/><br/>
            <label />Location : 
